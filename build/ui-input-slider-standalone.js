...
require.alias("ui-input-slider/index.js", "ui-input-slider/index.js");if (typeof exports == "object") {
  module.exports = require("ui-input-slider");
} else if (typeof define == "function" && define.amd) {
  define(function(){ return require("ui-input-slider"); });
} else {
  this["ui-input-slider"] = require("ui-input-slider");
}})();

uick.register(["draggy", "emitter", "events", "extend", "classes"]);
